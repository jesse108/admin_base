...
class Util_HttpRequest {
	...
	// /////////http parameter
	public static $connecttimeout = 3000; //ms
	public static $timeout = 3000;//ms
	...
	public static function ClearData(){
	    unset(self::$http_info);
	    unset(self::$http_code);
	    unset(self::$http_response);
	    unset(self::$http_postdata);
	    unset(self::$url);
	}
